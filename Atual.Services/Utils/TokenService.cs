...
namespace Atual.Services.Utils
{
                            ...
                            foreach (Role role in roles)
                            {
                                switch (eTypeAccess)
                                {
                                    ...
                                    case ETypeAccess.LevelCliente:
                                        if (role.LevelCliente >= levelAccess)
                                            return true;
                                        break;
                                    ...
                                    case ETypeAccess.LevelContrato:
                                        if (role.LevelContrato >= levelAccess)
                                            return true;
                                        break;
                                    case ETypeAccess.LevelFuncionarios:
                                        if (role.LevelFuncionarios >= levelAccess)
                                            return true;
                                        break;
                                    case ETypeAccess.LevelMontagens:
                                        if (role.LevelMontagens >= levelAccess)
                                            return true;      
                                        break;
