        ...
        public List<UserAndRole> GetAllUsers(Guid companyId) 
        {
            ...
            */
            ...
            var UsersComRoles = (from c in users
                         ...
                         select new { c.Id, c.Name, c.LastName, c.Email, ru.roleId }).Distinct().ToList();
            ...
            var UsersERoles = (from r in roles
                         ...
                         { 
                             ...
                             RoleId = r.Id ,
                             RoleName = r.Name ,
                             LevelAdmin = (int) r.LevelAdmin,
                             LevelDashBoard = (int) r.LevelDashBoard,
                             LevelProcess = (int) r.LevelProcess,
                             LevelWorkFlows = (int) r.LevelWorkFlows,
                             LevelStations =(int) r.LevelStations,
                             LevelUsers = (int) r.LevelUsers, 
                             LevelOperations = (int) r.LevelOperations,
                             LevelRoles = (int) r.LevelRoles
